...
MACRO_TUNING_PARAM(gun_speed, 1400.0f)
MACRO_TUNING_PARAM(gun_lifetime, 2.0f)

MACRO_TUNING_PARAM(shotgun_curvature, 0.0f)
MACRO_TUNING_PARAM(shotgun_speed, 500.0f)
MACRO_TUNING_PARAM(shotgun_speeddiff, 0.0f)
