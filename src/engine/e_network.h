...
public:
	...
	int set_callbacks(NETFUNC_NEWCLIENT new_client, NETFUNC_DELCLIENT del_client, void *user,const char *reason)
	{ return netserver_set_callbacks(ptr, new_client, del_client, user, reason); }
