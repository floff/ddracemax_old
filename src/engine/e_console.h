...
typedef void (*CONSOLE_CALLBACK)(void *result, void *user_data, int cid);
...
#define MACRO_REGISTER_COMMAND(name, params, flags, func, ptr, help,lvl) { static COMMAND cmd = { name, params, flags, func, ptr, help,lvl, 0x0}; console_register(&cmd); }
